...
func init() {
	plugin.RegisterProvider(&GitHubRepository{})
}
...
func (repo *GitHubRepository) GetInfo() (*plugin.RepositoryInfo, error) {
...
func (repo *GitHubRepository) CreateRelease(release *plugin.CreateReleaseConfig) error {
